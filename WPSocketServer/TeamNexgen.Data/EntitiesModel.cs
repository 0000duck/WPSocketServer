...
namespace TeamNexgen.Data	
{
	public partial class EntitiesModel : OpenAccessContext, IEntitiesModelUnitOfWork
	{
		...
		public IQueryable<Software> Softwares 
		{
			get
			{
		...
		public IQueryable<DataArrivalLog> DataArrivalLogs 
		{
			get
			{
				return this.GetAll<DataArrivalLog>();
			}
		}
		...
		public IQueryable<SendData> SendDatas 
		{
			get
			{
				return this.GetAll<SendData>();
			}
		}
	...
	public interface IEntitiesModelUnitOfWork : IUnitOfWork
	{
		...
		IQueryable<DataArrivalLog> DataArrivalLogs
		{
			get;
		}
